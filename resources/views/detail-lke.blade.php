            ...
            <div class="mx-auto max-w-[1600px] px-3 py-2 pb-3 sm:px-6">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        >
                            @include('components.status-lke', [
                                        'status' => $pertanyaan->status_pertanyaan
                                    ])
                         </div>
...
<script>
    ...
    */
    ...
    function renderStatusPertanyaan(id, status) {

        const element = document.getElementById(
            `status-pertanyaan-${id}`
        );
